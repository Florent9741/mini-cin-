<div x-data="{ modelOpen: false }">
    <i @click="modelOpen =!modelOpen" class="fa-solid fa-pen-to-square mx-2"></i>
                ...
                <form class="mt-5" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <div class="flex">
                            <div class="w-1/3">
                                <label for="categorie"
                                    class="block pt-3 pb-1 text-sm text-gray-700 capitalize dark:text-gray-600">Réalisateur</label>
                        ...
                        <div class="flex justify-between mt-2">
                            <label for="files"
                                class="flex items-center justify-center h-10 px-6 py-3 mt-4 space-x-2 text-sm tracking-wide text-white transition-colors duration-200 transform bg-red-700 rounded-md hover:bg-red-600 focus:outline-none focus:bg-red-500 focus:ring focus:ring-red-300 focus:ring-opacity-50">Ajouter
                                une affiche</label>
                            <input type="file" style="display:none" id="files" onchange="loadFile(event)" name="images"
                                value="" required>
